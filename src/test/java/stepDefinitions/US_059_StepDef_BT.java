...
public class US_059_StepDef_BT {
    ...
    public void organic_trade_buttons_should_be_functional() {
        ...
        if(!ypsp.checkBox_trade.isSelected()){
         ...
         WebElement product2 = Driver.getDriver().findElement(By.xpath("//*[text()='"+BrowserUtilities.readDataFromIdsFile("product")+"' and @class='ProductCard_productTitle__3K4rg']/../../div[@class='row d-flex justify-content-center']/button[2]"));
    ...
    public void delete_button_is_clicked() {
        JSUtils.clickElementByJS(ypsp.button_cancel);
    ...
    public void alert_should_be_displayed() {
         ...
         String expectedResult = BrowserUtilities.readDataFromIdsFile("product")+"  has been successfully deleted";
