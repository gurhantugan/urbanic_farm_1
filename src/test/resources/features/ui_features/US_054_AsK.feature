Feature:US_054 Various actions in the Delivery & Pick up settings  section
  ...
  Scenario:As a user, after entering valid information,
   Given user goes to Home Page
    ...
    And user clicks login buttoning
   ...
   Then "Start and end time cannot be same at the
   And user click buyer name button and click
    And user click delivery and pick up settBuyer picks up on the vine field." alert massage should be visible
  ...
  Scenario:As a user,I should be able to perform various actions in the Delivery & Pick up settings  section
    ...
    And user click buyer account button and click
