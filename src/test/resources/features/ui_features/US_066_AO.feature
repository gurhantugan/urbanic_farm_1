...
Feature: US_066 As a user, after entering valid information, I should be able to perform various actions in the Welcome Page
  ...
  Background: The user should be able to perform various operations in the basket.
    #Given user goes to "basket" page after login as a seller
    Given user goes to "basket" page after login
  @US_066_TC_001
  ...
  @US_066_TC_002
  Scenario: TC_002 Deleting item from basket and Deleting and cancelling item from basket
